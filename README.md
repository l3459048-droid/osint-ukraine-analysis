...
Для генерации ответа v0.6 использует локальный Ollama на `127.0.0.1:11434`. Программа сама получает список установленных моделей и, если конкретная модель не задана в config, использует первую доступную.
